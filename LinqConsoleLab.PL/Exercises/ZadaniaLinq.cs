...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        ...
        return new[] { czyIstnieje ? "Tak, istnieje nieaktywny zapis." : "Nie, wszystkie zapisy są aktywne." };
    }
    /// <summary>
    /// Zadanie:
    ...
    public IEnumerable<string> Zadanie06_CzyWszyscyProwadzacyMajaKatedre()
    {
        ...
        return new[] { wszyscyMaja ? "Tak, każdy prowadzący ma uzupełnioną katedrę." : "Nie, brakuje danych o katedrze." };
    }
    /// <summary>
    /// Zadanie:
    ...
    public IEnumerable<string> Zadanie10_DrugaStronaPrzedmiotow()
    {
        return DaneUczelni.Przedmioty
            ...
            .Skip(2)
            .Take(2)
            .Select(p => $"{p.Nazwa} (Kategoria: {p.Kategoria})");
    }
    /// <summary>
    /// Zadanie:
    ...
    public IEnumerable<string> Zadanie13_GrupowanieZapisowWedlugPrzedmiotu()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Przedmioty, g => g.Key, p => p.Id, (g, p) => $"Przedmiot: {p.Nazwa} | Zapisów: {g.Count()}");
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .GroupBy(z => z.PrzedmiotId)
            .Join(DaneUczelni.Przedmioty, g => g.Key, p => p.Id, (g, p) => $"{p.Nazwa} - Średnia: {g.Average(z => z.OcenaKoncowa.Value):F2}");
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Studenci, g => g.Key, s => s.Id, (g, s) => $"{s.Imie} {s.Nazwisko} - Max ocena: {g.Max(z => z.OcenaKoncowa.Value)}");
    }
    ...
    public IEnumerable<string> Wyzwanie01_StudenciZWiecejNizJednymAktywnymPrzedmiotem()
    {
        return DaneUczelni.Zapisy
            ...
            .GroupBy(z => z.StudentId)
            .Where(g => g.Count() > 1)
            .Join(DaneUczelni.Studenci, g => g.Key, s => s.Id, (g, s) => $"{s.Imie} {s.Nazwisko} - Liczba aktywnych przedmiotów: {g.Count()}");
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            ...
            .GroupJoin(DaneUczelni.Zapisy, p => p.Id, z => z.PrzedmiotId, (p, zapisy) => new { Przedmiot = p, Zapisy = zapisy })
            .Where(pz => pz.Zapisy.Any() && pz.Zapisy.All(z => z.OcenaKoncowa == null))
            .Select(pz => $"{pz.Przedmiot.Nazwa}");
    }
            ...
            .Select(pr => new 
            {
                ...
                Oceny = DaneUczelni.Przedmioty
                    ...
                    .Join(DaneUczelni.Zapisy.Where(z => z.OcenaKoncowa.HasValue), 
                        p => p.Id, z => z.PrzedmiotId, (p, z) => z.OcenaKoncowa.Value)
            })
            .Select(x => $"{x.Prowadzacy.Imie} {x.Prowadzacy.Nazwisko} - Średnia: {(x.Oceny.Any() ? x.Oceny.Average().ToString("F2") : "Brak ocen")}");
    }
    ...
    {
        return DaneUczelni.Studenci
            .Join(DaneUczelni.Zapisy.Where(z => z.CzyAktywny), s => s.Id, z => z.StudentId, (s, z) => s)
            .GroupBy(s => s.Miasto)
